...
class CheckInOutUtils {
  static Future<void> checkInOut(String uid) async {
    ...
    await DatabaseService()
        .usersService
        .updateUser(id: int.parse(userId), checkedIn: isNowCheckedIn);
    ...
    if (isCheckedIn) {
      ...
      await DatabaseService().attendanceService.addAttendance(
          userId: int.parse(userId), checkInTime: timestamp, date: timestamp);
    }
  }
}
